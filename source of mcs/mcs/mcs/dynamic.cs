...
namespace Mono.CSharp
{
	...
	//
	// Type expression with public dynamic type symbol
	//
	...
	class DynamicExpressionStatement : ExpressionStatement
	{
		...
		{
			//
			// This method generates all public infrastructure for a dynamic call. The
			...
			for (int i = 0; i < dyn_args_count; ++i) {
				...
				// Convert any public type like dynamic or null to object
